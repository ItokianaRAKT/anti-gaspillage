...
function Navbar() {
  return (
    <nav className="w-full fixed top-0 z-10">
      ...
      <div className="bg-[#2E6F40] flex justify-around items-center h-[5vh] text-2xl">
            
                <select className="text-white bg-[#1c4b29]  h-[5vh] pl-[4vh]">
                    <option>Toutes les catégories</option>
                    <option>Pain et patisserie</option>
