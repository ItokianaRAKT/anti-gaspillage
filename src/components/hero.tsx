            ...
            <div className="relative flex mt-20 h-[91.6vh] bg-green-50">
                ...
                <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div className="mt-30 -ml-30 flex ">
                        <button className="bg-primaryGreen -translate-x-[3vw] text-white text-3xl p-6 rounded-4xl  font-contenu">Trouver un repas</button>
                        <button className="bg-[#FBE9D5] text-primaryGreen text-3xl p-6 rounded-4xl font-contenu">Partager</button>
                    </div>
                </div>
            </div>
        </section>
