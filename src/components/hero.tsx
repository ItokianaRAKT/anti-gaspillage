    ...
    <section className="mb-[10vh]">
            <div className="relative flex mt-20 h-[91.6vh] bg-green-50">
                ...
                <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2">
                    <p className="-translate-x-1/3 -translate-y-1/2 text-[#2E6F40] text-[6vh] font-semibold h-1/2 flex justify-center items-center leading-20 rounded-4xl font-titre">
                        Moins de gaspillage, <br /> Plus de partage
                    </p>
                    <p className="text-2xl -translate-x-1/3 font-contenu">Ici, les repas ont une seconde chance. <br />Partagez ce que vous n’utilisez pas ou  trouvez <br /> près de chez vous ce qui mérite d’être savouré.</p>
