  ...
  return (
    <nav className="w-full fixed top-0 z-10">
      ...
      <div className="bg-[#2E6F40] flex justify-around items-center h-[7vh] text-2xl">
            ...
            <div className="flex  items-center border-2 h-[4vh] w-[40%] bg-white text-[#2E6F40] justify-between px-5 rounded-[10px]">
                <input
                    type="search"
              ...
              <Link to="/Panier" className="flex bg-green-50 w-[15%] text-[#2E6F40] rounded-[10px] px-[1vw]">
            <div className="flex">
